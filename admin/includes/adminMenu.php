...
<a href="admin.php" class="navbar-brand ml-4">DMS</a>
        ...
        <div class="collapse navbar-collapse" id="slider">
            <ul class="navbar-nav ml-auto mr-5">
                 ...
                 <li class="nav-item dropdown active mr-4"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Hii <?php echo $_SESSION['firstname']; ?> <i class="fas fa-user"></i></a>
