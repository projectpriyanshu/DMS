        ...
        <div class="container-fluid">
            <div class="jumbotron">
                ...
                <form action="" method="POST" id="form_data">
                    <div class="row mb-3">
                        <input type="text" name="id" id="emp_id" value="<?php echo $result['id'];  ?>" hidden>
                        <div class="col">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            ...
                            <input type="date" id="doj" class="form-control" value="<?php echo $result['doj'];?>"/>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            ...
                            <div class=" ml-4">
                          <input class="form-check-input" type="checkbox" id="status" <?php if($result['status'] == '1'){echo "checked";} else{echo "unchecked";} ?> /> Active
                          </div>
                        </div>
                    </div> 
